...
function register_custom_page_template() {
    // Registra il nuovo template di pagina
    add_theme_support('page-templates', array(
        'home2' => __('Home 2', 'nome-tema'), // 'home2' è il nome del template, 'Home 2' è il nome visualizzato nell'editor di WordPress
    ));
}
add_action('after_setup_theme', 'register_custom_page_template');